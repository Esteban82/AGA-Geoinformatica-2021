...
REM	Titulo del mapa
	SET	title=EJ6.3_Mapa_Pendiente+Aspecto
	echo %title%
...
d	gmt grdgradient %DEM% -D  -S%CUT%  -R -fg
...
rem	gmt grdclip "ingrid" -G"outgrid" -C10,20,30,40 -T-,3,12,22,-
...
rem	gmt grdclip "ingrid" -G"outgrid" -C1,2,3,4,5,6,7,8 -T-,22.5,67.5,112.5,157.5,202.5,247.5,292.5,337.5,-
rem	gmt grdclip "ingrid" -G"outgrid" -C1-8             -T-,22.5,67.5,112.5,157.5,202.5,247.5,292.5,337.5,-
	pause
