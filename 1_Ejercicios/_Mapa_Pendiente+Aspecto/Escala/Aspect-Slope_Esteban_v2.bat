...
REM
	SET CPT=Aspect-Slope_Esteban_v2.cpt
	SET W=0.5p

gmt begin Aspect-Slope_Esteban_v2 png
...
REM	Nivel de 4 cm
	...
	echo 0 0 -22.5 22.5  | gmt plot -SW%R% -C%CPT% -G+z -W%W% -Z51
	echo 0 0 22.5 67.5   | gmt plot -SW%R% -C%CPT% -G+z -W%W% -Z52
	echo 0 0 67.5 112.5  | gmt plot -SW%R% -C%CPT% -G+z -W%W% -Z53
	echo 0 0 112.5 157.5 | gmt plot -SW%R% -C%CPT% -G+z -W%W% -Z54
	echo 0 0 157.5 202.5 | gmt plot -SW%R% -C%CPT% -G+z -W%W% -Z55
	echo 0 0 202.5 247.5 | gmt plot -SW%R% -C%CPT% -G+z -W%W% -Z56
	echo 0 0 247.5 292.5 | gmt plot -SW%R% -C%CPT% -G+z -W%W% -Z57
	echo 0 0 292.5 337.5 | gmt plot -SW%R% -C%CPT% -G+z -W%W% -Z58
